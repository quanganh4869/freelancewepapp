...
export const HeroSection = ({ onOpenRequestModal }) => {
  ...
  return (
    <section className="relative pt-12 pb-16 md:pt-20 md:pb-24 border-b border-slate-200 dark:border-slate-800 font-sans overflow-hidden">
      
      {/* Background Subtle Grid Accent */}
      <div className="absolute inset-0 pointer-events-none opacity-20 dark:opacity-10 bg-[radial-gradient(#F97316_1px,transparent_1px)] [background-size:28px_28px]"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left reveal">
            ...
            {/* Freelancer Availability Tag */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-primary/10 border border-brand-primary/25 text-brand-primary text-xs font-mono font-bold tracking-wide">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
              <span>QUANG ANH FREELANCER • ĐANG NHẬN DỰ ÁN</span>
            </div>

            {/* Headline H1: Personal & Approachable */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.15] text-slate-900 dark:text-white font-display">
              Nhận Làm Website <br />
            ...
            <div className="inline-flex items-center gap-3 p-3.5 rounded-xl bg-orange-500/10 border border-orange-500/30 text-orange-600 dark:text-orange-400 font-mono text-xs font-bold shadow-sm">
              <Sparkles size={16} className="shrink-0" />
              <span>Giá từ <strong className="text-slate-900 dark:text-white text-sm underline font-display">1.000.000đ</strong> · Thời gian bàn giao từ <strong className="text-slate-900 dark:text-white text-sm font-display">1 tuần</strong></span>
            </div>

            {/* Core Value Checklist */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs font-bold text-slate-800 dark:text-slate-200 font-display pt-1">
              ...
              <div className="flex items-center gap-2">
                <Check size={16} className="text-brand-primary shrink-0" />
                <span>Thiết kế giao diện đẹp, hiển thị mượt trên di động</span>
              </div>
              <div className="flex items-center gap-2">
                <Check size={16} className="text-brand-primary shrink-0" />
                <span>Bàn giao mã nguồn & Hướng dẫn quản trị</span>
              </div>
              <div className="flex items-center gap-2">
                <Check size={16} className="text-brand-primary shrink-0" />
          ...
          {/* Right Column: Clean Freelancer Card */}
            ...
            <div className={`rounded-2xl border p-6 sm:p-7 space-y-5 shadow-lg ${
              ...
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-xl bg-brand-primary text-white font-mono font-bold flex items-center justify-center text-sm shadow-sm">
                    QA
                  </div>
                  <div>
                    <h3 className="text-base font-bold text-slate-900 dark:text-white font-display">Nguyễn Quang Anh</h3>
                    <p className="text-xs font-mono text-slate-500">Freelancer Web Developer</p>
                  </div>
                </div>
              ...
              <div className="space-y-2.5 text-xs">
                <div className="flex justify-between py-1.5 border-b border-slate-100 dark:border-slate-800/60">
                  <span className="text-slate-500 font-mono">Website cá nhân / CV:</span>
                  <span className="font-bold text-brand-primary font-mono">Từ 1.000.000đ</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-100 dark:border-slate-800/60">
                  <span className="text-slate-500 font-mono">Landing Page bán hàng:</span>
                  <span className="font-bold text-brand-primary font-mono">Từ 1.500.000đ</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-100 dark:border-slate-800/60">
                  <span className="text-slate-500 font-mono">Web Doanh nghiệp / Shop:</span>
                  <span className="font-bold text-brand-primary font-mono">Từ 2.000.000đ – 5.000.000đ</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-100 dark:border-slate-800/60">
                  <span className="text-slate-500 font-mono">Web App / Dashboard nhỏ:</span>
