  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn font-sans">
      ...
      >
        ...
        <div className="relative h-64 sm:h-80 w-full overflow-hidden rounded-t-xl font-sans">
          <img
          ...
          <div className="absolute bottom-4 left-6 right-6 flex flex-col sm:flex-row sm:items-end justify-between gap-2">
            <div>
              <span className="text-xs text-brand-primary bg-brand-primary/10 border border-brand-primary/20 px-2.5 py-1 rounded font-bold uppercase">
        ...
        <div className="p-6 sm:p-8 space-y-6 font-sans">
          ...
          <div className="border-b border-slate-800 pb-6">
            <p className="text-xs text-slate-400 uppercase tracking-wider mb-1 font-bold">Khách hàng / Doanh nghiệp</p>
          ...
          {project.metrics && (
            <div>
              <p className="text-xs text-slate-400 uppercase tracking-wider mb-3 font-bold">Cam kết & Thông số kỹ thuật</p>
          ...
          {/* Tech Stack Tags */}
          <div>
            <p className="text-xs text-slate-400 uppercase tracking-wider mb-3 font-bold">Công nghệ sử dụng (Tech Stack)</p>
            <div className="flex flex-wrap gap-2 font-sans">
              {project.techStack.map((tech, idx) => (
                <span
                  key={idx}
                  className="px-3 py-1 rounded bg-studio-950 border border-slate-800 text-xs font-semibold text-slate-300"
                >
                  {tech}
                </span>
              ))}
          ...
          <div className="pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 font-sans">
            <button
              onClick={() => {
                onClose();
