      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className={`p-7 rounded-2xl border space-y-6 shadow-md ${
              ...
              <div className="flex items-center gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 font-medium">Việt Nam • Hỗ trợ toàn quốc</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-7 space-y-6 reveal reveal-delay-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs font-bold text-slate-800 dark:text-slate-200">
              <div className="p-3.5 rounded-xl bg-white dark:bg-studio-900 border border-slate-200 dark:border-slate-800 shadow-sm flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-normal text-slate-500 mt-0.5">Không phát sinh chi phí thừa không cần thiết</p>
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-white dark:bg-studio-900 border border-slate-200 dark:border-slate-800 shadow-sm flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-normal text-slate-500 mt-0.5">Tối ưu mượt mà trên di động và máy tính</p>
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-white dark:bg-studio-900 border border-slate-200 dark:border-slate-800 shadow-sm flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-normal text-slate-500 mt-0.5">Bạn toàn quyền sở hữu website của mình</p>
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-white dark:bg-studio-900 border border-slate-200 dark:border-slate-800 shadow-sm flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-normal text-slate-500 mt-0.5">Hỗ trợ sửa lỗi và hướng dẫn cập nhật bài viết</p>
                </div>
              </div>
            </div>
