...
export const ProcessSection = ({ onOpenRequestModal }) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      details: 'Đảm bảo giao diện hiện đại, nhất quán theo thẩm mỹ Editorial Studio. Thử nghiệm trải nghiệm người dùng thực tế trước khi viết bất kỳ dòng code nào.'
    },
    {
      num: '04',
      title: 'Development',
  ...
  return (
    <section id="process" className="py-24 bg-studio-900 relative border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
            Quy trình làm việc minh bạch 7 bước
          </h2>
              ...
              <button
                ...
                className={`p-4 rounded-xl text-left border transition-all relative overflow-hidden ${
                  isActive
                    ...
                    : 'bg-studio-950/60 border-white/5 text-slate-400 hover:border-white/20 hover:text-slate-200'
                }`}
              >
        ...
        <div className="studio-card-border p-8 rounded-2xl bg-studio-950 flex flex-col md:flex-row items-center justify-between gap-8 border-brand-primary/20">
          ...
          <div className="shrink-0">
            <button
              ...
              className="flex items-center gap-2 bg-brand-primary hover:bg-brand-hover text-white text-sm font-semibold px-6 py-3.5 rounded-xl shadow-glow-primary transition-all"
            >
