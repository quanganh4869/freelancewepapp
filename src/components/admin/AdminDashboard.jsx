...
import { Search, Filter, Shield, Eye, Trash2, CheckCircle2, Clock, AlertCircle, RefreshCw, ChevronDown } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-white/10">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-extrabold text-white tracking-tight">
                Admin Control Center • Lead Management
              </h1>
            </div>
            <p className="text-xs text-slate-400 font-mono mt-1">
              Quản lý các yêu cầu phát triển Web App từ khách hàng, cập nhật tiến độ & xử lý hợp đồng
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs font-mono text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-3 py-1.5 rounded-lg flex items-center gap-1.5">
              ...
              <span>Real-time Lead Sync Active</span>
            </span>
          </div>
        </div>
