    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn font-sans">
      ...
      >
        ...
        <div className="text-center space-y-1.5 mb-6">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-brand-primary/10 border border-brand-primary/30 text-brand-primary text-xs font-bold mb-1">
            <Shield size={13} />
        ...
        {(localError || authError) && (
          <div className="p-3 mb-4 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-300 text-xs flex items-start gap-2 font-medium">
        ...
        <div className="space-y-4 font-sans">
          ...
          <div className="relative flex py-2 items-center">
            ...
            <span className="flex-shrink mx-3 text-[11px] font-semibold text-slate-500 uppercase">Hoặc đăng nhập trực tiếp</span>
            <div className="flex-grow border-t border-slate-800"></div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-studio-950 border border-slate-800 rounded-xl px-3 py-2.5 text-xs text-white placeholder-slate-600 focus:outline-none focus:border-brand-primary font-medium"
                />
              </div>
            </div>

            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">Mật khẩu xác thực</label>
              <input
                type="password"
                value={password}
